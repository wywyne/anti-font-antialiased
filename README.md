# anti-font-antialiased
Fix skinny fonts on macOS, one page at a time. 
A macOS browser extension that overrides forced -webkit-font-smoothing: antialiased and brings back native font legibility.
